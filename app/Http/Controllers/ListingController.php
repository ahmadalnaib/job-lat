...
class ListingController extends Controller
{
    ...
    {
        $listings=Listing::latest()->with('tags')->filter(request(['search']))->paginate(3);
        ...
        return view('listings.index',compact('listings','tags','categories','cities'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('dashboard')->with('success','welcome with us');
        } catch(\Exception $e) {
